...
void ThreadLauncher::ExecuteRequest(Request *req)
{
    ...
    /*
     * Wait until the value of max_outstanding_ exceeds 0. This serves the same
     * function as waiting on max_outstanding_ in ProcessLauncher.
     */
