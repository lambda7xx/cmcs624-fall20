...
```shell
git remote add cmsc624 https://github.com/umd-db/cmcs624-fall20
git pull cmsc624 master # you may have to fix merge conflicts
```
{% hint style="info" %}
To ensure that your private repo has the latest codebase at all times, please don't forget to synchronize the remote codebase (by `git pull cmsc624 master`) --- sometimes we may fix some bugs in new commits. This is a prototype, and we always encourage students to dig deep and find potential problems to improve it.
{% endhint %}
