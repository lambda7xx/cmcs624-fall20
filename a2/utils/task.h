...
///
template <typename R, typename A = Unit, typename B = Unit, typename C = Unit, typename D = Unit, typename E = Unit>
...
///
template <class T, typename R, typename A = Unit, typename B = Unit, typename C = Unit, typename D = Unit,
          typename E = Unit>
...
template <typename R>
inline void RunTemplated<R>::Run(R (*f)(), R* r)
{
    *r = f();
}
template <typename R>
template <typename A>
inline void RunTemplated<R>::Run(R (*f)(A), R* r, A a)
{
    *r = f(a);
}
template <typename R>
template <typename A, typename B>
inline void RunTemplated<R>::Run(R (*f)(A, B), R* r, A a, B b)
{
    *r = f(a, b);
}
template <typename R>
template <typename A, typename B, typename C>
inline void RunTemplated<R>::Run(R (*f)(A, B, C), R* r, A a, B b, C c)
{
    *r = f(a, b, c);
}
template <typename R>
template <typename A, typename B, typename C, typename D>
inline void RunTemplated<R>::Run(R (*f)(A, B, C, D), R* r, A a, B b, C c, D d)
{
    *r = f(a, b, c, d);
}
template <typename R>
template <typename A, typename B, typename C, typename D, typename E>
inline void RunTemplated<R>::Run(R (*f)(A, B, C, D, E), R* r, A a, B b, C c, D d, E e)
{
    *r = f(a, b, c, d, e);
}

template <>
inline void RunTemplated<void>::Run(void (*f)(), void* r)
{
    f();
}
template <>
template <typename A>
inline void RunTemplated<void>::Run(void (*f)(A), void* r, A a)
{
    f(a);
}
template <>
template <typename A, typename B>
inline void RunTemplated<void>::Run(void (*f)(A, B), void* r, A a, B b)
{
    f(a, b);
}
template <>
template <typename A, typename B, typename C>
inline void RunTemplated<void>::Run(void (*f)(A, B, C), void* r, A a, B b, C c)
{
    f(a, b, c);
}
template <>
template <typename A, typename B, typename C, typename D>
inline void RunTemplated<void>::Run(void (*f)(A, B, C, D), void* r, A a, B b, C c, D d)
{
    f(a, b, c, d);
}
template <>
template <typename A, typename B, typename C, typename D, typename E>
inline void RunTemplated<void>::Run(void (*f)(A, B, C, D, E), void* r, A a, B b, C c, D d, E e)
{
    f(a, b, c, d, e);
}

template <typename R, typename A, typename B, typename C, typename D, typename E>
Function<R, A, B, C, D, E>::Function(R (*f)(), R* r) : args_(0), r_(r), f0_(f)
{
    assert(typeid(R) != typeid(void));
}
template <typename R, typename A, typename B, typename C, typename D, typename E>
Function<R, A, B, C, D, E>::Function(R (*f)(A), R* r, A a) : args_(1), r_(r), f1_(f), a_(a)
{
    assert(typeid(R) != typeid(void));
}
template <typename R, typename A, typename B, typename C, typename D, typename E>
Function<R, A, B, C, D, E>::Function(R (*f)(A, B), R* r, A a, B b) : args_(2), r_(r), f2_(f), a_(a), b_(b)
{
    assert(typeid(R) != typeid(void));
}
template <typename R, typename A, typename B, typename C, typename D, typename E>
Function<R, A, B, C, D, E>::Function(R (*f)(A, B, C), R* r, A a, B b, C c)
    : args_(3), r_(r), f3_(f), a_(a), b_(b), c_(c)
{
    assert(typeid(R) != typeid(void));
}
template <typename R, typename A, typename B, typename C, typename D, typename E>
Function<R, A, B, C, D, E>::Function(R (*f)(A, B, C, D), R* r, A a, B b, C c, D d)
    : args_(4), r_(r), f4_(f), a_(a), b_(b), c_(c), d_(d)
{
    assert(typeid(R) != typeid(void));
}
template <typename R, typename A, typename B, typename C, typename D, typename E>
Function<R, A, B, C, D, E>::Function(R (*f)(A, B, C, D, E), R* r, A a, B b, C c, D d, E e)
    : args_(5), r_(r), f5_(f), a_(a), b_(b), c_(c), d_(d), e_(e)
{
    assert(typeid(R) != typeid(void));
}

template <typename R, typename A, typename B, typename C, typename D, typename E>
Function<R, A, B, C, D, E>::Function(void (*f)()) : args_(0), r_(NULL), f0_(f)
{
    assert(typeid(R) == typeid(void));
}
template <typename R, typename A, typename B, typename C, typename D, typename E>
Function<R, A, B, C, D, E>::Function(void (*f)(A), A a) : args_(1), r_(NULL), f1_(f), a_(a)
{
    assert(typeid(R) == typeid(void));
}
template <typename R, typename A, typename B, typename C, typename D, typename E>
Function<R, A, B, C, D, E>::Function(void (*f)(A, B), A a, B b) : args_(2), r_(NULL), f2_(f), a_(a), b_(b)
{
    assert(typeid(R) == typeid(void));
}
template <typename R, typename A, typename B, typename C, typename D, typename E>
Function<R, A, B, C, D, E>::Function(void (*f)(A, B, C), A a, B b, C c)
    : args_(3), r_(NULL), f3_(f), a_(a), b_(b), c_(c)
{
    assert(typeid(R) == typeid(void));
}
template <typename R, typename A, typename B, typename C, typename D, typename E>
Function<R, A, B, C, D, E>::Function(void (*f)(A, B, C, D), A a, B b, C c, D d)
    : args_(4), r_(NULL), f4_(f), a_(a), b_(b), c_(c), d_(d)
{
    assert(typeid(R) == typeid(void));
}
template <typename R, typename A, typename B, typename C, typename D, typename E>
Function<R, A, B, C, D, E>::Function(void (*f)(A, B, C, D, E), A a, B b, C c, D d, E e)
    : args_(5), r_(NULL), f5_(f), a_(a), b_(b), c_(c), d_(d), e_(e)
{
    assert(typeid(R) == typeid(void));
}
...
void Function<R, A, B, C, D, E>::Run()
{
    ...
    {
        case 0:
            RunTemplated<R>::Run(f0_, r_);
            break;
        case 1:
            RunTemplated<R>::Run(f1_, r_, a_);
            break;
        case 2:
            RunTemplated<R>::Run(f2_, r_, a_, b_);
            break;
        case 3:
            RunTemplated<R>::Run(f3_, r_, a_, b_, c_);
            break;
        case 4:
            RunTemplated<R>::Run(f4_, r_, a_, b_, c_, d_);
            break;
        case 5:
            RunTemplated<R>::Run(f5_, r_, a_, b_, c_, d_, e_);
            break;
    }
}
...
template <typename R>
template <class T>
inline void RunMethodTemplated<R>::Run(T* t, R (T::*f)(), R* r)
{
    *r = (t->*f)();
}
template <typename R>
template <class T, typename A>
inline void RunMethodTemplated<R>::Run(T* t, R (T::*f)(A), R* r, A a)
{
    *r = (t->*f)(a);
}
template <typename R>
template <class T, typename A, typename B>
inline void RunMethodTemplated<R>::Run(T* t, R (T::*f)(A, B), R* r, A a, B b)
{
    *r = (t->*f)(a, b);
}
template <typename R>
template <class T, typename A, typename B, typename C>
inline void RunMethodTemplated<R>::Run(T* t, R (T::*f)(A, B, C), R* r, A a, B b, C c)
{
    *r = (t->*f)(a, b, c);
}
template <typename R>
template <class T, typename A, typename B, typename C, typename D>
inline void RunMethodTemplated<R>::Run(T* t, R (T::*f)(A, B, C, D), R* r, A a, B b, C c, D d)
{
    *r = (t->*f)(a, b, c, d);
}
template <typename R>
template <class T, typename A, typename B, typename C, typename D, typename E>
inline void RunMethodTemplated<R>::Run(T* t, R (T::*f)(A, B, C, D, E), R* r, A a, B b, C c, D d, E e)
{
    *r = (t->*f)(a, b, c, d, e);
}
...
template <>
template <class T>
inline void RunMethodTemplated<void>::Run(T* t, void (T::*f)(), void* r)
{
    (t->*f)();
}
template <>
template <class T, typename A>
inline void RunMethodTemplated<void>::Run(T* t, void (T::*f)(A), void* r, A a)
{
    (t->*f)(a);
}
template <>
template <class T, typename A, typename B>
inline void RunMethodTemplated<void>::Run(T* t, void (T::*f)(A, B), void* r, A a, B b)
{
    (t->*f)(a, b);
}
template <>
template <class T, typename A, typename B, typename C>
inline void RunMethodTemplated<void>::Run(T* t, void (T::*f)(A, B, C), void* r, A a, B b, C c)
{
    (t->*f)(a, b, c);
}
template <>
template <class T, typename A, typename B, typename C, typename D>
inline void RunMethodTemplated<void>::Run(T* t, void (T::*f)(A, B, C, D), void* r, A a, B b, C c, D d)
{
    (t->*f)(a, b, c, d);
}
template <>
template <class T, typename A, typename B, typename C, typename D, typename E>
inline void RunMethodTemplated<void>::Run(T* t, void (T::*f)(A, B, C, D, E), void* r, A a, B b, C c, D d, E e)
{
    (t->*f)(a, b, c, d, e);
}

template <class T, typename R, typename A, typename B, typename C, typename D, typename E>
Method<T, R, A, B, C, D, E>::Method(T* t, R (T::*f)(), R* r) : args_(0), t_(t), f0_(f), r_(r)
{
}
template <class T, typename R, typename A, typename B, typename C, typename D, typename E>
Method<T, R, A, B, C, D, E>::Method(T* t, R (T::*f)(A), R* r, A a) : args_(1), t_(t), f1_(f), r_(r), a_(a)
{
}
template <class T, typename R, typename A, typename B, typename C, typename D, typename E>
...
template <class T, typename R, typename A, typename B, typename C, typename D, typename E>
Method<T, R, A, B, C, D, E>::Method(T* t, void (T::*f)()) : args_(0), t_(t), f0_(f), r_(NULL)
{
}
template <class T, typename R, typename A, typename B, typename C, typename D, typename E>
Method<T, R, A, B, C, D, E>::Method(T* t, void (T::*f)(A), A a) : args_(1), t_(t), f1_(f), r_(NULL), a_(a)
{
}
template <class T, typename R, typename A, typename B, typename C, typename D, typename E>
...
void Method<T, R, A, B, C, D, E>::Run()
{
    ...
    {
        case 0:
            RunMethodTemplated<R>::Run(t_, f0_, r_);
            break;
        case 1:
            RunMethodTemplated<R>::Run(t_, f1_, r_, a_);
            break;
        case 2:
            RunMethodTemplated<R>::Run(t_, f2_, r_, a_, b_);
            break;
        case 3:
            RunMethodTemplated<R>::Run(t_, f3_, r_, a_, b_, c_);
            break;
        case 4:
            RunMethodTemplated<R>::Run(t_, f4_, r_, a_, b_, c_, d_);
            break;
        case 5:
            RunMethodTemplated<R>::Run(t_, f5_, r_, a_, b_, c_, d_, e_);
            break;
    }
}
